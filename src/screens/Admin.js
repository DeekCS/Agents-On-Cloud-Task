...
export function Rooms() {
    ...
    useEffect(async () => {
        try {
            const data = await (
                await axios.get("/api/booking/getAllRooms")
            ).data;
            setRooms(data);
            setLoading(false);
        } catch (er) {
...
export function AddRoom() {
    ...
    const handleOnChange = (e) => {
        ...
        console.log(roomName, type, rentPerDay, maxCount, phoneNumber, description, image1, image2, image3);
    };
        ...
        <div className={'row'}>
            ...
            {loading && <Loader />}
                    ...
                    <div className={'form-group'}>
                        ...
                        <input type={'number'} className={'form-control'} value={maxCount} onChange={(e)=>{setMaxCount(e.target.value)}}/>
                    </div>
                    <div className={'form-group'}>
            ...
            <div className="col-md-5">
                ...
                <div className="form-group">
                    <label>Images</label>
                    <input type={'text'} className={'form-control'} value={image1} placeholder={'Enter Url for Image 1'} onChange={(e)=>{setImage1(e.target.value)}}/>
                    <input type={'text'} className={'form-control'} value={image2} placeholder={'Enter Url for Image 2'} onChange={(e)=>{setImage2(e.target.value)}}/>
                    <input type={'text'} className={'form-control'} value={image3} placeholder={'Enter Url for Image 3'} onChange={(e)=>{setImage3(e.target.value)}}/>
                </div>
            </div>
            <button className={'btn btn-primary w-25 mt-3'} onClick={addRoom}>Add Room</button>
        </div>
    )
}